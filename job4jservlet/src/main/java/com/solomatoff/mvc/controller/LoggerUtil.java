...
/**
 * Класс представляет собой набор методов для вывода списка пользователей в логгер в виде xml-документа
 */
public class LoggerUtil {
     ...
     */
    public void saveUsersToLog(List<User> users, Logger log) {
